...
if __name__ == '__main__':
    ...
    SAVE_PATH = os.path.join(os.path.dirname(DATA_PATH), 'block'.format(BLOCK_SIZE, STRIDE), 'data')
    ...
    for file_path in file_paths:
        ...
        room_name = os.path.basename(file_path)[:-4]
        block = room2blocks_wrapper(file_path, block_size=BLOCK_SIZE, stride=STRIDE, min_npts=MIN_NPTS)
