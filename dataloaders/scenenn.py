...
class SceneNNDataset(object):
    def __init__(self, cvfold, data_path):
        ...
        # statistic class labeled blocks
        class_blocks={0: 46805, 1: 34511, 2: 45791, 3: 9112, 4: 5123, 5: 20036, 6: 4765, 7: 10528, 8: 4991, 9: 2150, 10: 4561, 11: 2340, 12: 1655, 13: 0, 14: 11927, 15: 2244, 16: 1667, 17: 621, 18: 2758, 19: 481, 20: 158, 21: 1289, 22: 0, 23: 4873, 24: 2313, 25: 6957, 26: 2273, 27: 499, 28: 0, 29: 10668, 30: 2438, 31: 0, 32: 1248, 33: 0, 34: 928, 35: 2403, 36: 0, 37: 5083, 38: 373, 39: 0, 40: 19048}
        self.filter_classes = [k for k in class_blocks.keys() if class_blocks[k]==0]
        # for name in class_names:
        #     if class_blocks[self.type2class[name]]==0:
        #         print(name)
        ...
        # # random sample
        # self.fold_0 = ['bathtub', 'bed', 'bookshelf', 'cabinet', 'chair', 'counter', 'curtain',  'desk', 'door', 'floor', 'pillow', 'dresser', 'box', 'television',  'lamp', 'mirror', 'ceiling', 'whiteboard', 'shelves', 'towel']
        # self.fold_1 = ['furniture', 'picture', 'fridge', 'shower curtain', 'sink', 'sofa', 'table', 'toilet', 'wall', 'window', 'blinds', 'structure',  'floor mat', 'clothes', 'person', 'books', 'bag', 'night stand',  'prop', 'paper']
        # # random sample and remove unlabeled lables
        self.fold_0 = ['bed', 'bookshelf', 'cabinet', 'chair', 'counter', 'curtain',  'desk', 'door', 'floor', 'pillow', 'dresser', 'box', 'television',  'lamp', 'mirror', 'whiteboard']
        self.fold_1 = ['picture', 'fridge', 'sink', 'sofa', 'table', 'wall', 'window', 'structure',  'floor mat', 'clothes', 'books', 'bag', 'night stand',  'prop', 'paper', 'towel', 'shelves']
        ...
        #   if len(self.class2scans[nname])<100:
        #     print(nname, len(self.class2scans[nname]))
    ...
    def get_class2scans(self):
        ...
        if os.path.exists(class2scans_file):
            ...
            # min_ratio = .03  # to filter out scans with only rare labelled points
