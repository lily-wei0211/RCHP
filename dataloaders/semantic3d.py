...
class Semantic3DDataset(object):
    def __init__(self, cvfold, data_path):
        ...
        class_names = open(os.path.join(os.path.dirname(data_path), 'meta', 'semantic3d_classnames.txt')).readlines()
        ...
        # classnames = ['unlabeled points', 'man-made terrain', 'natural terrain', 'high vegetation',
        # 'low vegetation', 'buildings', 'hard scape', 'scanning artefacts', 'cars']  # Semantic3D
        # 5,8,6,3
        # 4,1,2,7
        self.fold_0 = ['buildings', 'cars', 'hard scape', 'high vegetation']
        self.fold_1 = ['low vegetation', 'man-made terrain', 'natural terrain', 'scanning artefacts']
