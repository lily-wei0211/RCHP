...
class NYUDepthV2Dataset(object):
    def __init__(self, cvfold, data_path):
        ...
        #NYUdepthv2
        self.fold_0 = ["wall", "cabinet", "chair", "door", "bookshelf", "counter", "desk", "curtain", "pillow", "floor mat", "ceiling", "refridgerator", "towel", "box", "person", "toilet", "lamp", "bag", "otherstructure"]
        self.fold_1 = ["floor", "bed", "sofa", "table", "window", "picture", "blinds", "shelves", "dresser", "mirror", "clothes", "books", "television", "paper", "shower curtain", "whiteboard", "night stand", "sink", "bathtub", "otherfurniture", "otherprop"]
